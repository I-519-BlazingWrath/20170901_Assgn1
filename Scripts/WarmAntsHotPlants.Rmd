...
plot(cco2.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160))
...
#plot.ts(abund.ts, type = "l", ylab = "Rodent Abundance (#/hectare)", xlab = "Time (year)", las = 1)
...
#FTR null hypot of nonstationarity
#attempt to transform ts to be stationary
hnco2tsdiff<-diff(hnco2ts,lag=1)
