...
minNminc<-read.csv("C:\\Users\\rmoge\\GitHub\\QB2017_DivPro\\Data\\minNminc.csv")
minNminh<-read.csv("C:\\Users\\rmoge\\GitHub\\QB2017_DivPro\\Data\\minNminh.csv")
minNminhn<-read.csv("C:\\Users\\rmoge\\GitHub\\QB2017_DivPro\\Data\\minNminhn.csv")
minNminn<-read.csv("C:\\Users\\rmoge\\GitHub\\QB2017_DivPro\\Data\\minNminn.csv")
...
plot.ts(orgNmincts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
orgNminc.sm<-SMA(orgNmincr$Nmin,n=2)
plot(orgNminc.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(orgNmincr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#FTR null hypot of nonstationarity
#attempt to transform ts to be stationary
orgNminctsdiff<-diff(orgNmincts,lag=2)
orgNmincadfdiff<-adf.test(orgNminctsdiff,alternative="stationary")
print(orgNmincadfdiff)
#P=0.4931. This is even less able to reject the null hypothesis of stationarity. Do not do the differencing.
...
#"Best model: ARIMA(0,0,0)(1,0,0)[2] with non-zero mean"
#Model is seasonal
fitorgNminc<-arima(orgNmincts,c(0,0,0),seasonal=list(order=c(1,0,0),period=2),include.mean=T)
tsdiag(fitorgNminc)
...
plot.ts(orgNminhts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
orgNminh.sm<-SMA(orgNminhr$Nmin,n=2)
plot(orgNminh.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(orgNminhr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#FTR null hypot of nonstationarity
#attempt to transform ts to be stationary
orgNminhtsdiff<-diff(orgNminhts,lag=2)
...
#"Best model: ARIMA(0,0,0)(1,0,0)[2] with non-zero mean"
#Model is seasonal
fitorgNminh<-arima(orgNminhts,c(0,0,0),seasonal=list(order=c(1,0,0),period=2),include.mean=T)
tsdiag(fitorgNminh)
...
plot.ts(orgNminhnts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
orgNminhn.sm<-SMA(orgNminhnr$Nmin,n=2)
plot(orgNminhn.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(orgNminhnr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#FTR null hypot of nonstationarity
#attempt to transform ts to be stationary
orgNminhntsdiff<-diff(orgNminhnts,lag=2)
orgNminhnadfdiff<-adf.test(orgNminhntsdiff,alternative="stationary")
print(orgNminhnadfdiff)
#P=0.4931. This is even less able to reject the null hypothesis of stationarity. Do not do the differencing.

#Examine and plot time lags using the partial autocorrelation function (PACF) and autocorrelation function (ACR).
acf(orgNminhntsdiff)
acf(orgNminhnts)
pacf(orgNminhntsdiff)
pacf(orgNminhnts)
#look fine even without the differencing
...
plot.ts(orgNminnts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
orgNminn.sm<-SMA(orgNminnr$Nmin,n=2)
plot(orgNminn.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(orgNminnr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#FTR null hypot of nonstationarity
#attempt to transform ts to be stationary
orgNminntsdiff<-diff(orgNminnts,lag=2)
...
#"Best model: ARIMA(0,0,0)(1,0,0)[2] with non-zero mean"
#Model is seasonal
fitorgNminn<-arima(orgNminnts,c(0,0,0),seasonal=list(order=c(1,0,0),period=2),include.mean=T)
tsdiag(fitorgNminn)
...
plot.ts(mineralNmincts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
mineralNminc.sm<-SMA(mineralNmincr$Nmin,n=2)
plot(mineralNminc.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(mineralNmincr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#FTR null hypot of nonstationarity
#attempt to transform ts to be stationary
mineralNminctsdiff<-diff(mineralNmincts,lag=2)
mineralNmincadfdiff<-adf.test(mineralNminctsdiff,alternative="stationary")
print(mineralNmincadfdiff)
#P=0.4931. This is even less able to reject the null hypothesis of stationarity. Do not do the differencing.

#Examine and plot time lags using the partial autocorrelation function (PACF) and autocorrelation function (ACR).
acf(mineralNminctsdiff)
acf(mineralNmincts)
pacf(mineralNminctsdiff)
pacf(mineralNmincts)
#look fine even without the differencing
...
#"Best model: ARIMA(0,0,0)(1,0,0)[2] with non-zero mean"
#Model is seasonal
fitmineralNminc<-arima(mineralNmincts,c(0,0,0),seasonal=list(order=c(1,0,0),period=2),include.mean=T)
...
plot.ts(mineralNminhts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
mineralNminh.sm<-SMA(mineralNminhr$Nmin,n=2)
plot(mineralNminh.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(mineralNminhr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#"Best model: ARIMA(0,0,0)(1,0,0)[2] with non-zero mean"
#Model is seasonal
fitmineralNminh<-arima(mineralNminhts,c(0,0,0),seasonal=list(order=c(1,0,0),period=2),include.mean=T)
...
plot.ts(mineralNminhnts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
mineralNminhn.sm<-SMA(mineralNminhnr$Nmin,n=2)
plot(mineralNminhn.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(mineralNminhnr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#FTR null hypot of nonstationarity
#attempt to transform ts to be stationary
mineralNminhntsdiff<-diff(mineralNminhnts,lag=2)
...
#"Best model: ARIMA(0,0,0)(1,0,0)[2] with non-zero mean"
#Model is seasonal
fitmineralNminhn<-arima(mineralNminhnts,c(0,0,0),seasonal=list(order=c(1,0,0),period=2),include.mean=T)
...
plot.ts(mineralNminnts,type="l", ylab="CO2 flux",xlab="Time (year)",las=1)
mineralNminn.sm<-SMA(mineralNminnr$Nmin,n=2)
plot(mineralNminn.sm,type = "l", col = "#56e4c6",ylab="CO2 flux",las=1,xlab="Timepoint",ylim=c(0,160),main="Heat + N Treatment")
lines(mineralNminnr$co2avg, col="black")
legend(0, 30, col = c("#56e4c6", "black"), lty = c(1,1),c("smooth", "non-smooth"), bty = "n", cex = 1.25)
#decomposition categs
...
#"Best model: ARIMA(0,0,0)(1,0,0)[2] with non-zero mean"
#Model is seasonal
fitmineralNminn<-arima(mineralNminnts,c(0,0,0),seasonal=list(order=c(1,0,0),period=2),include.mean=T)
